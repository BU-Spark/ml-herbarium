...
class IAMDataset(dataset.ArrayDataset):
    ...
    def __init__(self, parse_method, credentials=None,
        ...
        url_partial = "https://fki.tic.heia-fr.ch/DBs/iamDB/data/{filename}.tgz"
        ...
        if self._parse_method == "form":
            self._data_urls = [url_partial.format(filename="forms" + a) for a in ["A-D", "E-H", "I-Z"]]
        elif self._parse_method == "form_bb":
            self._data_urls = [url_partial.format(filename="forms" + a) for a in ["A-D", "E-H", "I-Z"]]
        elif self._parse_method == "form_original":
            self._data_urls = [url_partial.format(filename="forms" + a) for a in ["A-D", "E-H", "I-Z"]]
        elif self._parse_method == "line":
            self._data_urls = [url_partial.format(filename="lines")]
        elif self._parse_method == "word":
            self._data_urls = [url_partial.format(filename="words")]
        self._xml_url = "https://fki.tic.heia-fr.ch/DBs/iamDB/data/xml.tgz"
